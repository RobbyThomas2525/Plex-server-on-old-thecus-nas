...
if not the guild will still work if you have TheCus OS 6 7 both 32 and 64 bit you just need to get it from archive.org instead of me here's the URL where i got it from
