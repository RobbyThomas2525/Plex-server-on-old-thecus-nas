...
Update: i then desided now to use makemkv since i just realize it's a waste of time and space to try and do such high bitrate for 480P also it's a simpler tool and apparently free if your using it just for DVD also it has a linux port that also has a flatpak BUT IT'S UNVERIFIED 
